...
1. Adds support for all the flicklib gestures (this breaks the flick-demo):
   ...
   6. edge west east        -> start past the edge and swipe to the beard, covering about 70% of its surface, 
   7. edge east west
   8. edge south north
   9. edge north south
...
2. A ack_beep or acknowledge beep lets me know if a gesture is recognized which is mostly important for hold gesture. A ready_beep informs me that the script is ready for another recognition.
